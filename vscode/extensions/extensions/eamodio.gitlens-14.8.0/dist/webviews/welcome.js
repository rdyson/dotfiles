var e={d:(t,o)=>{for(var s in o)e.o(o,s)&&!e.o(t,s)&&Object.defineProperty(t,s,{enumerable:!0,get:o[s]})},o:(e,t)=>Object.prototype.hasOwnProperty.call(e,t)};void 0!==e&&Object.defineProperty(e,"p",{get:function(){try{if("string"!=typeof webpackResourceBasePath)throw new Error("WebpackRequireFrom: 'webpackResourceBasePath' is not a string or not available at runtime. See https://github.com/agoldis/webpack-require-from#troubleshooting");return webpackResourceBasePath}catch(e){return"#{root}/dist/webviews/"}},set:function(e){}});var t={};e.d(t,{a:()=>WelcomeApp});class IpcMessageType{constructor(e,t=!1,o=!1){this.method=e,this.reset=t,this.pack=o}}class IpcCommandType extends IpcMessageType{}class IpcNotificationType extends IpcMessageType{}function o(e,t,o){e.method===t.method&&o(t.params,e)}const s=new IpcCommandType("webview/ready"),r=new IpcCommandType("webview/focus");new IpcCommandType("command/execute"),new IpcCommandType("configuration/preview"),new IpcCommandType("configuration/update"),new IpcNotificationType("configuration/didChange"),new IpcNotificationType("configuration/didPreview"),new IpcNotificationType("webview/didOpenAnchor");const i=new IpcCommandType("welcome/configuration/update"),a=new IpcNotificationType("welcome/didChange",!0),c=new IpcNotificationType("org/settings/didChange");function l(e){const t=.001*performance.now();let o=Math.floor(t),s=Math.floor(t%1*1e9);return void 0!==e&&(o-=e[0],s-=e[1],s<0&&(o--,s+=1e9)),[o,s]}function d(e,t,o){let s,r,i,a,c;function l(e){const o=e-(r??0);return null==r||o>=t||o<0}function d(){const e=Date.now();if(l(e))h();else{c=setTimeout(d,t-(e-(r??0)))}}function h(){return c=void 0,s?function(){const t=s,o=i;return s=i=void 0,a=e.apply(o,t),a}():(s=void 0,i=void 0,a)}function p(...e){const h=Date.now(),p=l(h);return s=null!=o&&s?o(s,e):e,i=this,r=h,p&&null==c?(c=setTimeout(d,t),a):(null==c&&(c=setTimeout(d,t)),a)}return p.cancel=function(){null!=c&&clearTimeout(c),s=void 0,r=void 0,i=void 0,c=void 0},p.flush=function(){return null!=c?h():a},p.pending=function(){return null!=c},p}const h=",",p="=",f="{",u="(",g=")",y=/\(([\s\S]*)\)/,x=/(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm,m=/\s?=.*$/;const v=new class Logger2{constructor(){this._isDebugging=!1,this.level=0,this._logLevel="off"}configure(e,t,o=!1){this.provider=e,this._isDebugging=o,this.logLevel=t}enabled(e){return this.level>=C(e)}get isDebugging(){return this._isDebugging}get logLevel(){return this._logLevel}set logLevel(e){this._logLevel=e,this.level=C(this._logLevel),"off"===e?(this.output?.dispose?.(),this.output=void 0):this.output??=this.provider.createChannel(this.provider.name)}get timestamp(){return`[${(new Date).toISOString().replace(/T/," ").slice(0,-1)}]`}debug(e,...t){if(this.level<4&&!this.isDebugging)return;let o;"string"==typeof e?o=e:(o=t.shift(),null!=e&&(o=`${e.prefix} ${o??""}`)),this.isDebugging,null==this.output||this.level<4||this.output.appendLine(`${this.timestamp} ${o??""}${this.toLoggableParams(!0,t)}`)}error(e,t,...o){if(this.level<1&&!this.isDebugging)return;let s;if(s=null==t||"string"==typeof t?t:`${t.prefix} ${o.shift()??""}`,null==s){const t=e instanceof Error?e.stack:void 0;if(t){const e=/.*\s*?at\s(.+?)\s/.exec(t);null!=e&&(s=e[1])}}this.isDebugging,null==this.output||this.level<1||this.output.appendLine(`${this.timestamp} ${s??""}${this.toLoggableParams(!1,o)}${null!=e?`\n${String(e)}`:""}`)}log(e,...t){if(this.level<3&&!this.isDebugging)return;let o;"string"==typeof e?o=e:(o=t.shift(),null!=e&&(o=`${e.prefix} ${o??""}`)),this.isDebugging,null==this.output||this.level<3||this.output.appendLine(`${this.timestamp} ${o??""}${this.toLoggableParams(!1,t)}`)}warn(e,...t){if(this.level<2&&!this.isDebugging)return;let o;"string"==typeof e?o=e:(o=t.shift(),null!=e&&(o=`${e.prefix} ${o??""}`)),this.isDebugging,null==this.output||this.level<2||this.output.appendLine(`${this.timestamp} ${o??""}${this.toLoggableParams(!1,t)}`)}showOutputChannel(e){this.output?.show?.(e)}toLoggable(e,t){if("object"!=typeof e)return String(e);if(Array.isArray(e))return`[${e.map((e=>this.toLoggable(e,t))).join(", ")}]`;const o=this.provider.toLoggable?.(e);if(null!=o)return o;try{return JSON.stringify(e,t)}catch{return"<error>"}}toLoggableParams(e,t){if(0===t.length||e&&this.level<4&&!this.isDebugging)return"";const o=t.map((e=>this.toLoggable(e))).join(", ");return 0!==o.length?` — ${o}`:""}};function C(e){switch(e){case"off":default:return 0;case"error":return 1;case"warn":return 2;case"info":return 3;case"debug":return 4}}function w(e){let t;if("function"==typeof e){if(null==e.prototype?.constructor)return e.name;t=e.prototype.constructor.name??""}else t=e.constructor?.name??"";const o=t.indexOf("_");return-1===o?t:t.substr(o+1)}const _={enabled:e=>v.enabled(e)||v.isDebugging,log:(e,t,o,...s)=>{switch(e){case"error":v.error("",t,o,...s);break;case"warn":v.warn(t,o,...s);break;case"info":v.log(t,o,...s);break;default:v.debug(t,o,...s)}}},$=500,A=2**30,S=new Map;let P=0;function E(e){S.delete(e)}function B(e,t){if(null!=t)return{scopeId:t.scopeId,prefix:`${t.prefix}${e}`};const o=D();return{scopeId:o,prefix:`[${String(o).padStart(5)}] ${e}`}}function D(){return P===A&&(P=0),++P}Error;Error;var O=(e=>(e[e.Hash=35]="Hash",e[e.Slash=47]="Slash",e[e.Digit0=48]="Digit0",e[e.Digit1=49]="Digit1",e[e.Digit2=50]="Digit2",e[e.Digit3=51]="Digit3",e[e.Digit4=52]="Digit4",e[e.Digit5=53]="Digit5",e[e.Digit6=54]="Digit6",e[e.Digit7=55]="Digit7",e[e.Digit8=56]="Digit8",e[e.Digit9=57]="Digit9",e[e.Backslash=92]="Backslash",e[e.A=65]="A",e[e.B=66]="B",e[e.C=67]="C",e[e.D=68]="D",e[e.E=69]="E",e[e.F=70]="F",e[e.Z=90]="Z",e[e.a=97]="a",e[e.b=98]="b",e[e.c=99]="c",e[e.d=100]="d",e[e.e=101]="e",e[e.f=102]="f",e[e.z=122]="z",e))(O||{});const{fromCharCode:F}=String;new TextEncoder;function Z(e){const[t,o]=l(e);return 1e3*t+Math.floor(o/1e6)}const U=Symbol("logInstanceNameFn");Symbol.dispose??=Symbol("Symbol.dispose"),Symbol.asyncDispose??=Symbol("Symbol.asyncDispose");class Stopwatch{constructor(e,t,...o){let s;if(this._stopped=!1,this.logScope=null!=e&&"string"!=typeof e?e:B(e??""),s="boolean"==typeof t?.log?t.log?{}:void 0:t?.log??{},this.logLevel=t?.logLevel??"info",this.logProvider=t?.provider??_,this._time=l(),null!=s){if(!this.logProvider.enabled(this.logLevel))return;o.length?this.logProvider.log(this.logLevel,this.logScope,`${s.message??""}${s.suffix??""}`,...o):this.logProvider.log(this.logLevel,this.logScope,`${s.message??""}${s.suffix??""}`)}}get startTime(){return this._time}[Symbol.dispose](){this.stop()}elapsed(){const[e,t]=l(this._time);return 1e3*e+Math.floor(t/1e6)}log(e){this.logCore(e,!1)}restart(e){this.logCore(e,!0),this._time=l(),this._stopped=!1}stop(e){this._stopped||(this.restart(e),this._stopped=!0)}logCore(e,t){if(!this.logProvider.enabled(this.logLevel))return;if(!t)return void this.logProvider.log(this.logLevel,this.logScope,`${e?.message??""}${e?.suffix??""}`);const[o,s]=l(this._time),r=1e3*o+Math.floor(s/1e6),i=e?.message??"";this.logProvider.log(r>250?"warn":this.logLevel,this.logScope,`${i?`${i} `:""}[${r}ms]${e?.suffix??""}`)}}var T,z;function G(e,t){const o=e+t,s=t<0?o<0?0:o:o>255?255:o;return Math.round(s)}function N(e,t){return j(e,-t)}function j(e,t){const o=function(e){const t=oe(e);return null==t?null:[t.rgba.r,t.rgba.g,t.rgba.b,t.rgba.a]}(e);if(null==o)return e;const[s,r,i,a]=o,c=255*t/100;return`rgba(${G(s,c)}, ${G(r,c)}, ${G(i,c)}, ${a})`}function q(e,t){const o=J.from(e);return null==o?e:o.transparent(t/100).toString()}(z=T||(T={})).on=function(e,t,o,s){let r=!1;if("string"==typeof e){const i=function(t){const s=t?.target?.closest(e);null!=s&&o(t,s)};return document.addEventListener(t,i,s??!0),{dispose:()=>{r||(r=!0,document.removeEventListener(t,i,s??!0))}}}const i=function(e){o(e,this)};return e.addEventListener(t,i,s??!1),{dispose:()=>{r||(r=!0,e.removeEventListener(t,i,s??!1))}}},z.insertTemplate=function(e,t,o){const s=document.getElementById(e);if(t.replaceChildren(s?.content.cloneNode(!0)),t.className=s.className,null!=o?.visible){const e=t.querySelectorAll("[data-visible]");for(const t of e){const e=t.dataset.visible;e&&(o.visible[e]?t.style.display="initial":t.style.display="none")}}if(null!=o?.bindings){const e=t.querySelectorAll("[data-bind]");for(const t of e){const e=t.dataset.bind;if(!e)continue;const s=o.bindings[e];null!=s&&(t.textContent=String(s))}}},z.resetSlot=function(e){e.replaceChildren(),e.className=""};function W(e,t){const o=Math.pow(10,t);return Math.round(e*o)/o}class RGBA{constructor(e,t,o,s=1){this._rgbaBrand=void 0,this.r=0|Math.min(255,Math.max(0,e)),this.g=0|Math.min(255,Math.max(0,t)),this.b=0|Math.min(255,Math.max(0,o)),this.a=W(Math.max(Math.min(1,s),0),3)}static equals(e,t){return e.r===t.r&&e.g===t.g&&e.b===t.b&&e.a===t.a}}class HSLA{constructor(e,t,o,s){this._hslaBrand=void 0,this.h=0|Math.max(Math.min(360,e),0),this.s=W(Math.max(Math.min(1,t),0),3),this.l=W(Math.max(Math.min(1,o),0),3),this.a=W(Math.max(Math.min(1,s),0),3)}static equals(e,t){return e.h===t.h&&e.s===t.s&&e.l===t.l&&e.a===t.a}static fromRGBA(e){const t=e.r/255,o=e.g/255,s=e.b/255,r=e.a,i=Math.max(t,o,s),a=Math.min(t,o,s);let c=0,l=0;const d=(a+i)/2,h=i-a;if(h>0){switch(l=Math.min(d<=.5?h/(2*d):h/(2-2*d),1),i){case t:c=(o-s)/h+(o<s?6:0);break;case o:c=(s-t)/h+2;break;case s:c=(t-o)/h+4}c*=60,c=Math.round(c)}return new HSLA(c,l,d,r)}static _hue2rgb(e,t,o){return o<0&&(o+=1),o>1&&(o-=1),o<1/6?e+6*(t-e)*o:o<.5?t:o<2/3?e+(t-e)*(2/3-o)*6:e}static toRGBA(e){const t=e.h/360,{s:o,l:s,a:r}=e;let i,a,c;if(0===o)i=a=c=s;else{const e=s<.5?s*(1+o):s+o-s*o,r=2*s-e;i=HSLA._hue2rgb(r,e,t+1/3),a=HSLA._hue2rgb(r,e,t),c=HSLA._hue2rgb(r,e,t-1/3)}return new RGBA(Math.round(255*i),Math.round(255*a),Math.round(255*c),r)}}class HSVA{constructor(e,t,o,s){this._hsvaBrand=void 0,this.h=0|Math.max(Math.min(360,e),0),this.s=W(Math.max(Math.min(1,t),0),3),this.v=W(Math.max(Math.min(1,o),0),3),this.a=W(Math.max(Math.min(1,s),0),3)}static equals(e,t){return e.h===t.h&&e.s===t.s&&e.v===t.v&&e.a===t.a}static fromRGBA(e){const t=e.r/255,o=e.g/255,s=e.b/255,r=Math.max(t,o,s),i=r-Math.min(t,o,s),a=0===r?0:i/r;let c;return c=0===i?0:r===t?((o-s)/i%6+6)%6:r===o?(s-t)/i+2:(t-o)/i+4,new HSVA(Math.round(60*c),a,r,e.a)}static toRGBA(e){const{h:t,s:o,v:s,a:r}=e,i=s*o,a=i*(1-Math.abs(t/60%2-1)),c=s-i;let[l,d,h]=[0,0,0];return t<60?(l=i,d=a):t<120?(l=a,d=i):t<180?(d=i,h=a):t<240?(d=a,h=i):t<300?(l=a,h=i):t<=360&&(l=i,h=a),l=Math.round(255*(l+c)),d=Math.round(255*(d+c)),h=Math.round(255*(h+c)),new RGBA(l,d,h,r)}}function K(e,t){return t.getPropertyValue(e).trim()}const Q=class _Color{static from(e){return e instanceof _Color?e:oe(e)||_Color.red}static fromCssVariable(e,t){return oe(K(e,t))||_Color.red}static fromHex(e){return ne(e)||_Color.red}static equals(e,t){return!e&&!t||!(!e||!t)&&e.equals(t)}get hsla(){return this._hsla?this._hsla:HSLA.fromRGBA(this.rgba)}get hsva(){return this._hsva?this._hsva:HSVA.fromRGBA(this.rgba)}constructor(e){if(!e)throw new Error("Color needs a value");if(e instanceof RGBA)this.rgba=e;else if(e instanceof HSLA)this._hsla=e,this.rgba=HSLA.toRGBA(e);else{if(!(e instanceof HSVA))throw new Error("Invalid color ctor argument");this._hsva=e,this.rgba=HSVA.toRGBA(e)}}equals(e){return null!=e&&(Boolean(e)&&RGBA.equals(this.rgba,e.rgba)&&HSLA.equals(this.hsla,e.hsla)&&HSVA.equals(this.hsva,e.hsva))}getRelativeLuminance(){return W(.2126*_Color._relativeLuminanceForComponent(this.rgba.r)+.7152*_Color._relativeLuminanceForComponent(this.rgba.g)+.0722*_Color._relativeLuminanceForComponent(this.rgba.b),4)}static _relativeLuminanceForComponent(e){const t=e/255;return t<=.03928?t/12.92:Math.pow((t+.055)/1.055,2.4)}luminance(e){return function(e,t){if(0===t)return new J(new RGBA(0,0,0,e.rgba.a));if(1===t)return new J(new RGBA(255,255,255,e.rgba.a));const o=e.getRelativeLuminance();let s=20;const r=(e,o)=>{const i=e.mix(o,.5),a=i.getRelativeLuminance();return Math.abs(t-a)<1e-7||!s--?i:a>t?r(e,i):r(i,o)},i=(o>t?r(J.black,e):r(e,J.white)).rgba;return new J(new RGBA(i.r,i.g,i.b,e.rgba.a))}(this,e)}getContrastRatio(e){const t=this.getRelativeLuminance(),o=e.getRelativeLuminance();return t>o?(t+.05)/(o+.05):(o+.05)/(t+.05)}isDarker(){return(299*this.rgba.r+587*this.rgba.g+114*this.rgba.b)/1e3<128}isLighter(){return(299*this.rgba.r+587*this.rgba.g+114*this.rgba.b)/1e3>=128}isLighterThan(e){return this.getRelativeLuminance()>e.getRelativeLuminance()}isDarkerThan(e){return this.getRelativeLuminance()<e.getRelativeLuminance()}lighten(e){return new _Color(new HSLA(this.hsla.h,this.hsla.s,this.hsla.l+this.hsla.l*e,this.hsla.a))}darken(e){return new _Color(new HSLA(this.hsla.h,this.hsla.s,this.hsla.l-this.hsla.l*e,this.hsla.a))}transparent(e){const{r:t,g:o,b:s,a:r}=this.rgba;return new _Color(new RGBA(t,o,s,r*e))}isTransparent(){return 0===this.rgba.a}isOpaque(){return 1===this.rgba.a}opposite(){return new _Color(new RGBA(255-this.rgba.r,255-this.rgba.g,255-this.rgba.b,this.rgba.a))}blend(e){const t=e.rgba,o=this.rgba.a,s=t.a,r=o+s*(1-o);if(r<1e-6)return _Color.transparent;const i=this.rgba.r*o/r+t.r*s*(1-o)/r,a=this.rgba.g*o/r+t.g*s*(1-o)/r,c=this.rgba.b*o/r+t.b*s*(1-o)/r;return new _Color(new RGBA(i,a,c,r))}mix(e,t){return function(e,t,o){const s=e.rgba,r=t.rgba;return new J(new RGBA(s.r+o*(r.r-s.r),s.g+o*(r.g-s.g),s.b+o*(r.b-s.b),s.a+o*(r.a-s.a)))}(this,e,t)}makeOpaque(e){if(this.isOpaque()||1!==e.rgba.a)return this;const{r:t,g:o,b:s,a:r}=this.rgba;return new _Color(new RGBA(e.rgba.r-r*(e.rgba.r-t),e.rgba.g-r*(e.rgba.g-o),e.rgba.b-r*(e.rgba.b-s),1))}flatten(...e){const t=e.reduceRight(((e,t)=>_Color._flatten(t,e)));return _Color._flatten(this,t)}static _flatten(e,t){const o=1-e.rgba.a;return new _Color(new RGBA(o*t.rgba.r+e.rgba.a*e.rgba.r,o*t.rgba.g+e.rgba.a*e.rgba.g,o*t.rgba.b+e.rgba.a*e.rgba.b))}toString(){return this._toString||(this._toString=function(e){if(e.isOpaque())return ee(e);return X(e)}(this)),this._toString}static getLighterColor(e,t,o){if(e.isLighterThan(t))return e;o=o||.5;const s=e.getRelativeLuminance(),r=t.getRelativeLuminance();return o=o*(r-s)/r,e.lighten(o)}static getDarkerColor(e,t,o){if(e.isDarkerThan(t))return e;o=o||.5;const s=e.getRelativeLuminance();return o=o*(s-t.getRelativeLuminance())/s,e.darken(o)}};Q.white=new Q(new RGBA(255,255,255,1)),Q.black=new Q(new RGBA(0,0,0,1)),Q.red=new Q(new RGBA(255,0,0,1)),Q.blue=new Q(new RGBA(0,0,255,1)),Q.green=new Q(new RGBA(0,255,0,1)),Q.cyan=new Q(new RGBA(0,255,255,1)),Q.lightgrey=new Q(new RGBA(211,211,211,1)),Q.transparent=new Q(new RGBA(0,0,0,0));let J=Q;function X(e){return`rgba(${e.rgba.r}, ${e.rgba.g}, ${e.rgba.b}, ${Number(e.rgba.a.toFixed(2))})`}function Y(e){const t=e.toString(16);return 2!==t.length?`0${t}`:t}function ee(e){return`#${Y(e.rgba.r)}${Y(e.rgba.g)}${Y(e.rgba.b)}`}const te=/^((?:rgb|hsl)a?)\((-?\d+%?)[,\s]+(-?\d+%?)[,\s]+(-?\d+%?)[,\s]*(-?[\d.]+%?)?\)$/i;function oe(e){if(0===(e=e.trim()).length)return null;if(e.charCodeAt(0)===O.Hash)return ne(e);const t=te.exec(e);if(null==t)return null;const o=t[1];let s;switch(o){case"rgb":case"hsl":s=[parseInt(t[2],10),parseInt(t[3],10),parseInt(t[4],10),1];break;case"rgba":case"hsla":s=[parseInt(t[2],10),parseInt(t[3],10),parseInt(t[4],10),parseFloat(t[5])];break;default:return null}switch(o){case"rgb":case"rgba":return new J(new RGBA(s[0],s[1],s[2],s[3]));case"hsl":case"hsla":return new J(new HSLA(s[0],s[1],s[2],s[3]))}return J.red}function ne(e){const t=(e=e.trim()).length;if(0===t)return null;if(e.charCodeAt(0)!==O.Hash)return null;switch(t){case 7:{const t=16*se(e.charCodeAt(1))+se(e.charCodeAt(2)),o=16*se(e.charCodeAt(3))+se(e.charCodeAt(4)),s=16*se(e.charCodeAt(5))+se(e.charCodeAt(6));return new J(new RGBA(t,o,s,1))}case 9:{const t=16*se(e.charCodeAt(1))+se(e.charCodeAt(2)),o=16*se(e.charCodeAt(3))+se(e.charCodeAt(4)),s=16*se(e.charCodeAt(5))+se(e.charCodeAt(6)),r=16*se(e.charCodeAt(7))+se(e.charCodeAt(8));return new J(new RGBA(t,o,s,r/255))}case 4:{const t=se(e.charCodeAt(1)),o=se(e.charCodeAt(2)),s=se(e.charCodeAt(3));return new J(new RGBA(16*t+t,16*o+o,16*s+s))}case 5:{const t=se(e.charCodeAt(1)),o=se(e.charCodeAt(2)),s=se(e.charCodeAt(3)),r=se(e.charCodeAt(4));return new J(new RGBA(16*t+t,16*o+o,16*s+s,(16*r+r)/255))}default:return null}}function se(e){switch(e){case O.Digit0:return 0;case O.Digit1:return 1;case O.Digit2:return 2;case O.Digit3:return 3;case O.Digit4:return 4;case O.Digit5:return 5;case O.Digit6:return 6;case O.Digit7:return 7;case O.Digit8:return 8;case O.Digit9:return 9;case O.a:case O.A:return 10;case O.b:case O.B:return 11;case O.c:case O.C:return 12;case O.d:case O.D:return 13;case O.e:case O.E:return 14;case O.f:case O.F:return 15}return 0}const re=class _Emitter{constructor(){this._disposed=!1}get event(){return null==this._event&&(this._event=(e,t,o)=>{null==this.listeners&&(this.listeners=new LinkedList);const s=this.listeners.push(null==t?e:[e,t]),r={dispose:()=>{r.dispose=_Emitter._noop,this._disposed||s()}};return Array.isArray(o)&&o.push(r),r}),this._event}fire(e){if(null!=this.listeners){null==this._deliveryQueue&&(this._deliveryQueue=new LinkedList);for(let t=this.listeners.iterator(),o=t.next();!o.done;o=t.next())this._deliveryQueue.push([o.value,e]);for(;this._deliveryQueue.size>0;){const[e,t]=this._deliveryQueue.shift();try{"function"==typeof e?e(t):e[0].call(e[1],t)}catch(e){}}}}dispose(){this.listeners?.clear(),this._deliveryQueue?.clear(),this._disposed=!0}};re._noop=function(){};let ie=re;const ae={done:!0,value:void 0},ce=class _Node{constructor(e){this.element=e,this.next=_Node.Undefined,this.prev=_Node.Undefined}};ce.Undefined=new ce(void 0);let le=ce;class LinkedList{constructor(){this._first=le.Undefined,this._last=le.Undefined,this._size=0}get size(){return this._size}isEmpty(){return this._first===le.Undefined}clear(){this._first=le.Undefined,this._last=le.Undefined,this._size=0}unshift(e){return this._insert(e,!1)}push(e){return this._insert(e,!0)}_insert(e,t){const o=new le(e);if(this._first===le.Undefined)this._first=o,this._last=o;else if(t){const e=this._last;this._last=o,o.prev=e,e.next=o}else{const e=this._first;this._first=o,o.next=e,e.prev=o}this._size+=1;let s=!1;return()=>{s||(s=!0,this._remove(o))}}shift(){if(this._first===le.Undefined)return;const e=this._first.element;return this._remove(this._first),e}pop(){if(this._last===le.Undefined)return;const e=this._last.element;return this._remove(this._last),e}_remove(e){if(e.prev!==le.Undefined&&e.next!==le.Undefined){const t=e.prev;t.next=e.next,e.next.prev=t}else e.prev===le.Undefined&&e.next===le.Undefined?(this._first=le.Undefined,this._last=le.Undefined):e.next===le.Undefined?(this._last=this._last.prev,this._last.next=le.Undefined):e.prev===le.Undefined&&(this._first=this._first.next,this._first.prev=le.Undefined);this._size-=1}iterator(){let e,t=this._first;return{next:function(){return t===le.Undefined?ae:(null==e?e={done:!1,value:t.element}:e.value=t.element,t=t.next,e)}}}toArray(){const e=[];for(let t=this._first;t!==le.Undefined;t=t.next)e.push(t.element);return e}}const de=new ie,he=de.event;function pe(e){const t=document.documentElement,o=window.getComputedStyle(t),s=document.body.classList,r=s.contains("vscode-light")||s.contains("vscode-high-contrast-light"),i=s.contains("vscode-high-contrast")||s.contains("vscode-high-contrast-light"),a=t.style,c=K("--vscode-editor-background",o);let l=K("--vscode-editor-foreground",o);l||(l=K("--vscode-foreground",o));let d=K("--color-background",o);return a.setProperty("--color-background--lighten-05",j(d,5)),a.setProperty("--color-background--darken-05",N(d,5)),a.setProperty("--color-background--lighten-075",j(d,7.5)),a.setProperty("--color-background--darken-075",N(d,7.5)),a.setProperty("--color-background--lighten-10",j(d,10)),a.setProperty("--color-background--darken-10",N(d,10)),a.setProperty("--color-background--lighten-15",j(d,15)),a.setProperty("--color-background--darken-15",N(d,15)),a.setProperty("--color-background--lighten-30",j(d,30)),a.setProperty("--color-background--darken-30",N(d,30)),a.setProperty("--color-background--lighten-50",j(d,50)),a.setProperty("--color-background--darken-50",N(d,50)),d=K("--color-button-background",o),a.setProperty("--color-button-background--darken-30",N(d,30)),d=K("--color-highlight",o),a.setProperty("--color-highlight--75",q(d,75)),a.setProperty("--color-highlight--50",q(d,50)),a.setProperty("--color-highlight--25",q(d,25)),d=K("--color-button-secondary-background",o),a.setProperty("--color-button-secondary-background--darken-30",N(d,30)),d=K("--color-foreground",o),a.setProperty("--color-foreground--85",q(d,85)),a.setProperty("--color-foreground--75",q(d,75)),a.setProperty("--color-foreground--65",q(d,65)),a.setProperty("--color-foreground--50",q(d,50)),d=K("--color-link-foreground",o),a.setProperty("--color-link-foreground--darken-20",N(d,20)),a.setProperty("--color-link-foreground--lighten-20",j(d,20)),d=K("--color-alert-infoBackground",o),a.setProperty("--color-alert-infoHoverBackground",r?N(d,5):j(d,5)),d=K("--color-alert-warningBackground",o),a.setProperty("--color-alert-warningHoverBackground",r?N(d,5):j(d,5)),d=K("--color-alert-errorBackground",o),a.setProperty("--color-alert-errorHoverBackground",r?N(d,5):j(d,5)),d=r?N(c,5):j(c,5),a.setProperty("--color-alert-neutralBackground",d),a.setProperty("--color-alert-neutralHoverBackground",r?N(d,5):j(d,5)),{colors:{background:c,foreground:l},computedStyle:o,isLightTheme:r,isHighContrastTheme:i,isInitializing:null==e}}var fe=Object.defineProperty,be=Object.getOwnPropertyDescriptor;let ue=0;function ge(){return 1073741824===ue?ue=1:ue++,`webview:${ue}`}const ye=new TextDecoder;class App{constructor(e){this.appName=e;const t=[],o=pe();if(null!=this.onThemeUpdated&&(this.onThemeUpdated(o),t.push(he(this.onThemeUpdated,this))),this.state=window.bootstrap,window.bootstrap=void 0,this.placement=document.body.getAttribute("data-placement")??"editor",v.configure({name:e,createChannel:function(e){return{name:e,appendLine:function(e){}}}},"off"),this.log(`${e}()`),this._api=acquireVsCodeApi(),null!=this.state){const e=this.getState();this.state.timestamp>=(e?.timestamp??0)?this._api.setState(this.state):this.state=e}t.push(function(){const e=new MutationObserver((e=>{de.fire(pe(e))}));return e.observe(document.body,{attributeFilter:["class"]}),{dispose:()=>e.disconnect()}}()),requestAnimationFrame((()=>{this.log(`${e}(): initializing...`);try{this.onInitialize?.(),this.bind(),null!=this.onMessageReceived&&t.push(T.on(window,"message",(e=>this.onMessageReceivedCore(e)))),this.sendCommand(s,void 0),this.onInitialized?.()}finally{document.body.classList.contains("preload")&&setTimeout((()=>{document.body.classList.remove("preload")}),500)}})),t.push(T.on(window,"pagehide",(()=>{t?.forEach((e=>e.dispose())),this.bindDisposables?.forEach((e=>e.dispose())),this.bindDisposables=void 0})))}onMessageReceivedCore(e){const t=S.get(P),o=e.data;if(o.packed&&o.params instanceof Uint8Array){const s=function(e,t,...o){return(t?.provider??_).enabled(t?.logLevel??"info")?new Stopwatch(e,t,...o):void 0}(B(` deserializing msg=${e.data.method}`,t),{log:!1,logLevel:"debug"});o.params=JSON.parse(ye.decode(o.params)),s?.stop()}this.onMessageReceived(o)}bind(){this.bindDisposables?.forEach((e=>e.dispose())),this.bindDisposables=this.onBind?.(),null==this.bindDisposables&&(this.bindDisposables=[]);const e=d((e=>{this.sendCommand(r,e)}),150);this.bindDisposables.push(T.on(document,"focusin",(t=>{const o=t.composedPath().some((e=>"INPUT"===e.tagName));!0===this._focused&&this._inputFocused===o||(this._focused=!0,this._inputFocused=o,e({focused:!0,inputFocused:o}))})),T.on(document,"focusout",(()=>{!1===this._focused&&!1===this._inputFocused||(this._focused=!1,this._inputFocused=!1,e({focused:!1,inputFocused:!1}))})))}log(e,...t){"string"==typeof e?v.log(e,...t):v.log(e,t.shift(),...t)}getState(){return this._api.getState()}sendCommand(e,t){const o=ge();this.log(`${this.appName}.sendCommand(${o}): name=${e.method}`),this.postMessage({id:o,method:e.method,params:t})}async sendCommandWithCompletion(e,t,s){const r=ge();this.log(`${this.appName}.sendCommandWithCompletion(${r}): name=${e.method}`);const i=new Promise(((e,t)=>{let i;const a=[T.on(window,"message",(t=>{o(s,t.data,(o=>{t.data.completionId===r&&(a.forEach((e=>e.dispose())),queueMicrotask((()=>e(o))))}))})),{dispose:function(){null!=i&&(clearTimeout(i),i=void 0)}}];i=setTimeout((()=>{i=void 0,a.forEach((e=>e.dispose())),t(new Error(`Timed out waiting for completion of ${s.method}`))}),6e4)}));return this.postMessage({id:r,method:e.method,params:t,completionId:r}),i}setState(e){this._api.setState(e)}postMessage(e){this._api.postMessage(e)}}var xe;((e,t,o,s)=>{for(var r,i=s>1?void 0:s?be(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(i=(s?r(t,o,i):r(i))||i);s&&i&&fe(t,o,i)})([(xe={args:{0:e=>`${e.data.id}, method=${e.data.method}`}},function(e,t=!1){let o,s,r,i,a,c=0,d=!1,C=!1,_=!0;null!=e&&({args:o,if:s,enter:r,exit:i,prefix:a,logThreshold:c=0,scoped:d=!0,singleLine:C=!1,timed:_=!0}=e),c>0&&(C=!0,_=!0),_&&(d=!0);const A=v.isDebugging,P=t?v.debug:v.log,B=A?"debug":"info";return(e,t,O)=>{let F,T;if("function"==typeof O.value?(F=O.value,T="value"):"function"==typeof O.get&&(F=O.get,T="get"),null==F||null==T)throw new Error("Not supported");const z=!1!==o?function(e){if("function"!=typeof e)throw new Error("Not supported");if(0===e.length)return[];let t=Function.prototype.toString.call(e);t=t.replace(x,"")||t,t=t.slice(0,t.indexOf(f));let o=t.indexOf(u),s=t.indexOf(g);o=o>=0?o+1:0,s=s>0?s:t.indexOf(p),t=t.slice(o,s),t=`(${t})`;const r=y.exec(t);return null!=r?r[1].split(h).map((e=>e.trim().replace(m,""))):[]}(F):[];O[T]=function(...e){if(!A&&!v.enabled(B)||null!=s&&!s.apply(this,e))return F.apply(this,e);const h=D(),p=null!=this?this.constructor?.[U]?.(this,w(this))??w(this):void 0;let f,u=p?d?`[${h.toString(16).padStart(5)}] ${p}.${t}`:`${p}.${t}`:t;null!=a&&(u=a({id:h,instance:this,instanceName:p??"",name:t,prefix:u},...e)),d&&(f={scopeId:h,prefix:u},function(e,t){S.set(e,t)}(h,f));const g=null!=r?r(...e):"";let y;if(!1===o||0===e.length)y="",C||P.call(v,`${u}${g}`);else{let t;y="";let s,r,i,a=-1;for(i of e){if(s=z[++a],t=o?.[a],null!=t){if("boolean"==typeof t)continue;if(y.length>0&&(y+=", "),"string"==typeof t){y+=t;continue}r=String(t(i))}else y.length>0&&(y+=", "),r=v.toLoggable(i);y+=s?`${s}=${r}`:r}C||P.call(v,y?`${u}${g}(${y})`:`${u}${g}`)}if(C||_||null!=i){const t=_?l():void 0,o=e=>{const o=void 0!==t?` [${Z(t)}ms]`:"";C?v.error(e,y?`${u}${g}(${y})`:`${u}${g}`,f?.exitDetails?`failed${f.exitDetails}${o}`:`failed${o}`):v.error(e,u,f?.exitDetails?`failed${f.exitDetails}${o}`:`failed${o}`),d&&E(h)};let s;try{s=F.apply(this,e)}catch(e){throw o(e),e}const r=e=>{let o,s,r,a;if(null!=t?(o=Z(t),o>$?(s=v.warn,r=` [*${o}ms] (slow)`):(s=P,r=` [${o}ms]`)):(r="",s=P),null!=i)if("function"==typeof i)try{a=i(e)}catch(e){a=`@log.exit error: ${e}`}else!0===i&&(a=`returned ${v.toLoggable(e)}`);else f?.exitFailed?(a=f.exitFailed,s=v.error):a="completed";C?(0===c||o>c)&&s.call(v,y?`${u}${g}(${y}) ${a}${f?.exitDetails||""}${r}`:`${u}${g} ${a}${f?.exitDetails||""}${r}`):s.call(v,y?`${u}(${y}) ${a}${f?.exitDetails||""}${r}`:`${u} ${a}${f?.exitDetails||""}${r}`),d&&E(h)};return null!=s&&null!=(x=s)&&(x instanceof Promise||"function"==typeof x?.then)?s.then(r,o):r(s),s}var x;return F.apply(this,e)}}}(xe,!0))],App.prototype,"onMessageReceivedCore",1);const me=globalThis,ve=me.ShadowRoot&&(void 0===me.ShadyCSS||me.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ce=Symbol(),we=new WeakMap;class n{constructor(e,t,o){if(this._$cssResult$=!0,o!==Ce)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(ve&&void 0===e){const o=void 0!==t&&1===t.length;o&&(e=we.get(t)),void 0===e&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),o&&we.set(t,e))}return e}toString(){return this.cssText}}const _e=(e,...t)=>{const o=1===e.length?e[0]:t.reduce(((t,o,s)=>t+(e=>{if(!0===e._$cssResult$)return e.cssText;if("number"==typeof e)return e;throw Error("Value passed to 'css' function must be a 'css' function result: "+e+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+e[s+1]),e[0]);return new n(o,e,Ce)},ke=ve?e=>e:e=>e instanceof CSSStyleSheet?(e=>{let t="";for(const o of e.cssRules)t+=o.cssText;return(e=>new n("string"==typeof e?e:e+"",void 0,Ce))(t)})(e):e,{is:$e,defineProperty:Ae,getOwnPropertyDescriptor:Le,getOwnPropertyNames:Me,getOwnPropertySymbols:Se,getPrototypeOf:Pe}=Object,Ee=globalThis,Be=Ee.trustedTypes,De=Be?Be.emptyScript:"",Oe=Ee.reactiveElementPolyfillSupport,He=(e,t)=>e,Fe={toAttribute(e,t){switch(t){case Boolean:e=e?De:null;break;case Object:case Array:e=null==e?e:JSON.stringify(e)}return e},fromAttribute(e,t){let o=e;switch(t){case Boolean:o=null!==e;break;case Number:o=null===e?null:Number(e);break;case Object:case Array:try{o=JSON.parse(e)}catch(e){o=null}}return o}},Re=(e,t)=>!$e(e,t),Ze={attribute:!0,type:String,converter:Fe,reflect:!1,hasChanged:Re};Symbol.metadata??=Symbol("metadata"),Ee.litPropertyMetadata??=new WeakMap;class b extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Ze){if(t.state&&(t.attribute=!1),this._$Ei(),this.elementProperties.set(e,t),!t.noAccessor){const o=Symbol(),s=this.getPropertyDescriptor(e,o,t);void 0!==s&&Ae(this.prototype,e,s)}}static getPropertyDescriptor(e,t,o){const{get:s,set:r}=Le(this.prototype,e)??{get(){return this[t]},set(e){this[t]=e}};return{get(){return s?.call(this)},set(t){const i=s?.call(this);r.call(this,t),this.requestUpdate(e,i,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Ze}static _$Ei(){if(this.hasOwnProperty(He("elementProperties")))return;const e=Pe(this);e.finalize(),void 0!==e.l&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(He("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(He("properties"))){const e=this.properties,t=[...Me(e),...Se(e)];for(const o of t)this.createProperty(o,e[o])}const e=this[Symbol.metadata];if(null!==e){const t=litPropertyMetadata.get(e);if(void 0!==t)for(const[e,o]of t)this.elementProperties.set(e,o)}this._$Eh=new Map;for(const[e,t]of this.elementProperties){const o=this._$Eu(e,t);void 0!==o&&this._$Eh.set(o,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const o=new Set(e.flat(1/0).reverse());for(const e of o)t.unshift(ke(e))}else void 0!==e&&t.push(ke(e));return t}static _$Eu(e,t){const o=t.attribute;return!1===o?void 0:"string"==typeof o?o:"string"==typeof e?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((e=>this.enableUpdating=e)),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((e=>e(this)))}addController(e){(this._$EO??=new Set).add(e),void 0!==this.renderRoot&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const o of t.keys())this.hasOwnProperty(o)&&(e.set(o,this[o]),delete this[o]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((e,t)=>{if(ve)e.adoptedStyleSheets=t.map((e=>e instanceof CSSStyleSheet?e:e.styleSheet));else for(const o of t){const t=document.createElement("style"),s=me.litNonce;void 0!==s&&t.setAttribute("nonce",s),t.textContent=o.cssText,e.appendChild(t)}})(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((e=>e.hostConnected?.()))}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach((e=>e.hostDisconnected?.()))}attributeChangedCallback(e,t,o){this._$AK(e,o)}_$EC(e,t){const o=this.constructor.elementProperties.get(e),s=this.constructor._$Eu(e,o);if(void 0!==s&&!0===o.reflect){const r=(void 0!==o.converter?.toAttribute?o.converter:Fe).toAttribute(t,o.type);this._$Em=e,null==r?this.removeAttribute(s):this.setAttribute(s,r),this._$Em=null}}_$AK(e,t){const o=this.constructor,s=o._$Eh.get(e);if(void 0!==s&&this._$Em!==s){const e=o.getPropertyOptions(s),r="function"==typeof e.converter?{fromAttribute:e.converter}:void 0!==e.converter?.fromAttribute?e.converter:Fe;this._$Em=s,this[s]=r.fromAttribute(t,e.type),this._$Em=null}}requestUpdate(e,t,o){if(void 0!==e){if(o??=this.constructor.getPropertyOptions(e),!(o.hasChanged??Re)(this[e],t))return;this.P(e,t,o)}!1===this.isUpdatePending&&(this._$ES=this._$ET())}P(e,t,o){this._$AL.has(e)||this._$AL.set(e,t),!0===o.reflect&&this._$Em!==e&&(this._$Ej??=new Set).add(e)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const e=this.scheduleUpdate();return null!=e&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[e,t]of this._$Ep)this[e]=t;this._$Ep=void 0}const e=this.constructor.elementProperties;if(e.size>0)for(const[t,o]of e)!0!==o.wrapped||this._$AL.has(t)||void 0===this[t]||this.P(t,this[t],o)}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach((e=>e.hostUpdate?.())),this.update(t)):this._$EU()}catch(t){throw e=!1,this._$EU(),t}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach((e=>e.hostUpdated?.())),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Ej&&=this._$Ej.forEach((e=>this._$EC(e,this[e]))),this._$EU()}updated(e){}firstUpdated(e){}}b.elementStyles=[],b.shadowRootOptions={mode:"open"},b[He("elementProperties")]=new Map,b[He("finalized")]=new Map,Oe?.({ReactiveElement:b}),(Ee.reactiveElementVersions??=[]).push("2.0.4");const Ue=globalThis,Te=Ue.trustedTypes,Ie=Te?Te.createPolicy("lit-html",{createHTML:e=>e}):void 0,Ve="$lit$",ze=`lit$${(Math.random()+"").slice(9)}$`,Ge="?"+ze,Ne=`<${Ge}>`,je=document,qe=()=>je.createComment(""),We=e=>null===e||"object"!=typeof e&&"function"!=typeof e,Ke=Array.isArray,Qe=e=>Ke(e)||"function"==typeof e?.[Symbol.iterator],Je="[ \t\n\f\r]",Xe=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ye=/-->/g,et=/>/g,tt=RegExp(`>|${Je}(?:([^\\s"'>=/]+)(${Je}*=${Je}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),ot=/'/g,nt=/"/g,st=/^(?:script|style|textarea|title)$/i,rt=e=>(t,...o)=>({_$litType$:e,strings:t,values:o}),it=rt(1),at=rt(2),ct=Symbol.for("lit-noChange"),lt=Symbol.for("lit-nothing"),dt=new WeakMap,ht=je.createTreeWalker(je,129);function pt(e,t){if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==Ie?Ie.createHTML(t):t}const ft=(e,t)=>{const o=e.length-1,s=[];let r,i=2===t?"<svg>":"",a=Xe;for(let t=0;t<o;t++){const o=e[t];let c,l,d=-1,h=0;for(;h<o.length&&(a.lastIndex=h,l=a.exec(o),null!==l);)h=a.lastIndex,a===Xe?"!--"===l[1]?a=Ye:void 0!==l[1]?a=et:void 0!==l[2]?(st.test(l[2])&&(r=RegExp("</"+l[2],"g")),a=tt):void 0!==l[3]&&(a=tt):a===tt?">"===l[0]?(a=r??Xe,d=-1):void 0===l[1]?d=-2:(d=a.lastIndex-l[2].length,c=l[1],a=void 0===l[3]?tt:'"'===l[3]?nt:ot):a===nt||a===ot?a=tt:a===Ye||a===et?a=Xe:(a=tt,r=void 0);const p=a===tt&&e[t+1].startsWith("/>")?" ":"";i+=a===Xe?o+Ne:d>=0?(s.push(c),o.slice(0,d)+Ve+o.slice(d)+ze+p):o+ze+(-2===d?t:p)}return[pt(e,i+(e[o]||"<?>")+(2===t?"</svg>":"")),s]};class V{constructor({strings:e,_$litType$:t},o){let s;this.parts=[];let r=0,i=0;const a=e.length-1,c=this.parts,[l,d]=ft(e,t);if(this.el=V.createElement(l,o),ht.currentNode=this.el.content,2===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(s=ht.nextNode())&&c.length<a;){if(1===s.nodeType){if(s.hasAttributes())for(const e of s.getAttributeNames())if(e.endsWith(Ve)){const t=d[i++],o=s.getAttribute(e).split(ze),a=/([.?@])?(.*)/.exec(t);c.push({type:1,index:r,name:a[2],strings:o,ctor:"."===a[1]?k:"?"===a[1]?H:"@"===a[1]?I:R}),s.removeAttribute(e)}else e.startsWith(ze)&&(c.push({type:6,index:r}),s.removeAttribute(e));if(st.test(s.tagName)){const e=s.textContent.split(ze),t=e.length-1;if(t>0){s.textContent=Te?Te.emptyScript:"";for(let o=0;o<t;o++)s.append(e[o],qe()),ht.nextNode(),c.push({type:2,index:++r});s.append(e[t],qe())}}}else if(8===s.nodeType)if(s.data===Ge)c.push({type:2,index:r});else{let e=-1;for(;-1!==(e=s.data.indexOf(ze,e+1));)c.push({type:7,index:r}),e+=ze.length-1}r++}}static createElement(e,t){const o=je.createElement("template");return o.innerHTML=e,o}}function bt(e,t,o=e,s){if(t===ct)return t;let r=void 0!==s?o._$Co?.[s]:o._$Cl;const i=We(t)?void 0:t._$litDirective$;return r?.constructor!==i&&(r?._$AO?.(!1),void 0===i?r=void 0:(r=new i(e),r._$AT(e,o,s)),void 0!==s?(o._$Co??=[])[s]=r:o._$Cl=r),void 0!==r&&(t=bt(e,r._$AS(e,t.values),r,s)),t}class lit_html_S{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:o}=this._$AD,s=(e?.creationScope??je).importNode(t,!0);ht.currentNode=s;let r=ht.nextNode(),i=0,a=0,c=o[0];for(;void 0!==c;){if(i===c.index){let t;2===c.type?t=new M(r,r.nextSibling,this,e):1===c.type?t=new c.ctor(r,c.name,c.strings,this,e):6===c.type&&(t=new L(r,this,e)),this._$AV.push(t),c=o[++a]}i!==c?.index&&(r=ht.nextNode(),i++)}return ht.currentNode=je,s}p(e){let t=0;for(const o of this._$AV)void 0!==o&&(void 0!==o.strings?(o._$AI(e,o,t),t+=o.strings.length-2):o._$AI(e[t])),t++}}class M{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,o,s){this.type=2,this._$AH=lt,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=o,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=bt(this,e,t),We(e)?e===lt||null==e||""===e?(this._$AH!==lt&&this._$AR(),this._$AH=lt):e!==this._$AH&&e!==ct&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):Qe(e)?this.k(e):this._(e)}S(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.S(e))}_(e){this._$AH!==lt&&We(this._$AH)?this._$AA.nextSibling.data=e:this.T(je.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:o}=e,s="number"==typeof o?this._$AC(e):(void 0===o.el&&(o.el=V.createElement(pt(o.h,o.h[0]),this.options)),o);if(this._$AH?._$AD===s)this._$AH.p(t);else{const e=new lit_html_S(s,this),o=e.u(this.options);e.p(t),this.T(o),this._$AH=e}}_$AC(e){let t=dt.get(e.strings);return void 0===t&&dt.set(e.strings,t=new V(e)),t}k(e){Ke(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let o,s=0;for(const r of e)s===t.length?t.push(o=new M(this.S(qe()),this.S(qe()),this,this.options)):o=t[s],o._$AI(r),s++;s<t.length&&(this._$AR(o&&o._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e&&e!==this._$AB;){const t=e.nextSibling;e.remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class R{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,o,s,r){this.type=1,this._$AH=lt,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=r,o.length>2||""!==o[0]||""!==o[1]?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=lt}_$AI(e,t=this,o,s){const r=this.strings;let i=!1;if(void 0===r)e=bt(this,e,t,0),i=!We(e)||e!==this._$AH&&e!==ct,i&&(this._$AH=e);else{const s=e;let a,c;for(e=r[0],a=0;a<r.length-1;a++)c=bt(this,s[o+a],t,a),c===ct&&(c=this._$AH[a]),i||=!We(c)||c!==this._$AH[a],c===lt?e=lt:e!==lt&&(e+=(c??"")+r[a+1]),this._$AH[a]=c}i&&!s&&this.j(e)}j(e){e===lt?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class k extends R{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===lt?void 0:e}}class H extends R{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==lt)}}class I extends R{constructor(e,t,o,s,r){super(e,t,o,s,r),this.type=5}_$AI(e,t=this){if((e=bt(this,e,t,0)??lt)===ct)return;const o=this._$AH,s=e===lt&&o!==lt||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,r=e!==lt&&(o===lt||s);s&&this.element.removeEventListener(this.name,this,o),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class L{constructor(e,t,o){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(e){bt(this,e)}}const ut=Ue.litHtmlPolyfillSupport;ut?.(V,M),(Ue.litHtmlVersions??=[]).push("3.1.2");class lit_element_s extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,o)=>{const s=o?.renderBefore??t;let r=s._$litPart$;if(void 0===r){const e=o?.renderBefore??null;s._$litPart$=r=new M(t.insertBefore(qe(),e),e,void 0,o??{})}return r._$AI(e),r})(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return ct}}lit_element_s._$litElement$=!0,lit_element_s.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:lit_element_s});const gt=globalThis.litElementPolyfillSupport;gt?.({LitElement:lit_element_s});(globalThis.litElementVersions??=[]).push("4.0.4");const yt=e=>(t,o)=>{void 0!==o?o.addInitializer((()=>{customElements.define(e,t)})):customElements.define(e,t)},xt={attribute:!0,type:String,converter:Fe,reflect:!1,hasChanged:Re},mt=(e=xt,t,o)=>{const{kind:s,metadata:r}=o;let i=globalThis.litPropertyMetadata.get(r);if(void 0===i&&globalThis.litPropertyMetadata.set(r,i=new Map),i.set(o.name,e),"accessor"===s){const{name:s}=o;return{set(o){const r=t.get.call(this);t.set.call(this,o),this.requestUpdate(s,r,e)},init(t){return void 0!==t&&this.P(s,void 0,e),t}}}if("setter"===s){const{name:s}=o;return function(o){const r=this[s];t.call(this,o),this.requestUpdate(s,r,e)}}throw Error("Unsupported decorator location: "+s)};function vt(e){return(t,o)=>"object"==typeof o?mt(e,t,o):((e,t,o)=>{const s=t.hasOwnProperty(o);return t.constructor.createProperty(o,s?{...e,wrapped:!0}:e),s?Object.getOwnPropertyDescriptor(t,o):void 0})(e,t,o)}const Ct=(e,t,o)=>(o.configurable=!0,o.enumerable=!0,Reflect.decorate&&"object"!=typeof t&&Object.defineProperty(e,t,o),o);var wt=Object.defineProperty,_t=Object.getOwnPropertyDescriptor,kt=(e,t,o,s)=>{for(var r,i=s>1?void 0:s?_t(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(i=(s?r(t,o,i):r(i))||i);return s&&i&&wt(t,o,i),i};let $t=class extends lit_element_s{constructor(){super(...arguments),this.icon="",this.modifier="",this.size=16}updated(e){e.has("size")&&this.style.setProperty("--code-icon-size",`${this.size}px`),super.update(e)}};$t.styles=_e`
		:host {
	...
	`,kt([vt()],$t.prototype,"icon",2),kt([vt()],$t.prototype,"modifier",2),kt([vt({type:Number})],$t.prototype,"size",2),$t=kt([yt("code-icon")],$t);_e`
	.sr-only,
...
`;var Mt=Object.defineProperty,St=Object.getOwnPropertyDescriptor,Pt=(e,t,o,s)=>{for(var r,i=s>1?void 0:s?St(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(i=(s?r(t,o,i):r(i))||i);return s&&i&&Mt(t,o,i),i};let Et=class extends lit_element_s{constructor(){super(...arguments),this.full=!1,this.disabled=!1}get role(){return this.href?"link":"button"}updated(e){super.updated(e),e.has("disabled")&&this.setAttribute("aria-disabled",this.disabled.toString())}render(){return null!=this.href?it`<a class="control" part="base" tabindex="${!1===this.disabled?-1:0}" href=${this.href}
				><slot></slot
			></a>`:it`<button class="control" part="base" ?disabled=${this.disabled}><slot></slot></button>`}focus(e){this.control.focus(e)}blur(){this.control.blur()}click(){this.control.click()}};Et.shadowRootOptions={...lit_element_s.shadowRootOptions,delegatesFocus:!0},Et.styles=[Lt,_e`
			:host {
		...
		`],Pt([function(e,t){return(o,s,r)=>{const i=t=>t.renderRoot?.querySelector(e)??null;if(t){const{get:e,set:t}="object"==typeof s?o:r??(()=>{const e=Symbol();return{get(){return this[e]},set(t){this[e]=t}}})();return Ct(o,s,{get(){let o=e.call(this);return void 0===o&&(o=i(this),(null!==o||this.hasUpdated)&&t.call(this,o)),o}})}return Ct(o,s,{get(){return i(this)}})}}(".control")],Et.prototype,"control",2),Pt([vt({type:Boolean,reflect:!0})],Et.prototype,"full",2),Pt([vt({type:Boolean,reflect:!0})],Et.prototype,"disabled",2),Pt([vt({reflect:!0})],Et.prototype,"density",2),Pt([vt()],Et.prototype,"href",2),Pt([vt({reflect:!0})],Et.prototype,"role",1),Pt([vt()],Et.prototype,"appearance",2),Et=Pt([yt("gl-button")],Et);var Bt=Object.defineProperty,Dt=Object.getOwnPropertyDescriptor,Ot=(e,t,o,s)=>{for(var r,i=s>1?void 0:s?Dt(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(i=(s?r(t,o,i):r(i))||i);return s&&i&&Bt(t,o,i),i};let Ht=class extends lit_element_s{render(){const e=it`
			<div class="header">
		...
		`;return null!=this.href?it`<a href=${this.href}>${e}</a>`:e}};Ht.styles=[Lt,_e`
			:host {
				display: block;
				padding: 1.6rem;
		...
		`],Ot([vt()],Ht.prototype,"href",2),Ht=Ot([yt("gk-card")],Ht);var Ft=Object.defineProperty,Rt=Object.getOwnPropertyDescriptor;let Zt=class extends lit_element_s{render(){return it`<svg
			alt="GitLens"
			width="159"
			height="46"
			viewBox="0 0 159 46"
		...
		`],Zt=((e,t,o,s)=>{for(var r,i=s>1?void 0:s?Rt(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(i=(s?r(t,o,i):r(i))||i);return s&&i&&Ft(t,o,i),i})([yt("gitlens-logo")],Zt);var Ut=Object.defineProperty,Tt=Object.getOwnPropertyDescriptor,It=(e,t,o,s)=>{for(var r,i=s>1?void 0:s?Tt(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(i=(s?r(t,o,i):r(i))||i);return s&&i&&Ut(t,o,i),i};let Vt=class extends lit_element_s{render(){return it`
	...
	`,It([vt({type:Boolean,reflect:!0})],Vt.prototype,"toggled",2),Vt=It([yt("gk-annotations-svg")],Vt);var zt=Object.defineProperty,Gt=Object.getOwnPropertyDescriptor,Nt=(e,t,o,s)=>{for(var r,i=s>1?void 0:s?Gt(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(i=(s?r(t,o,i):r(i))||i);return s&&i&&zt(t,o,i),i};let jt=class extends lit_element_s{onMouseOver(){this.hovered=!0,this.hovering=this.inline}onMouseOut(){this.hovered=!0,this.hovering=!1}render(){return it`
			<!-- Don't reformat or let prettier reformat the SVG otherwise whitespace will get added incorrect and screw up the positioning -->
			<!-- prettier-ignore -->
	...
	`,Nt([vt({type:Boolean,reflect:!0})],jt.prototype,"inline",2),Nt([vt({type:Boolean,reflect:!0})],jt.prototype,"codelens",2),Nt([vt({type:Boolean,reflect:!0})],jt.prototype,"hovered",2),Nt([vt({type:Boolean,reflect:!0})],jt.prototype,"hovering",2),jt=Nt([yt("gk-blame-svg")],jt);var qt=Object.defineProperty,Wt=Object.getOwnPropertyDescriptor,Kt=(e,t,o,s)=>{for(var r,i=s>1?void 0:s?Wt(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(i=(s?r(t,o,i):r(i))||i);return s&&i&&qt(t,o,i),i};let Qt=class extends lit_element_s{onClick(e){switch(e.target.dataset.feature){case"annotations":{this.annotationsToggled=!this.annotationsToggled;const e=document.getElementById("annotations");e.toggled=!e.toggled;break}case"revision":{this.revisionToggled=!this.revisionToggled;const e=document.getElementById("revision");e.toggled=!e.toggled;break}}this.dispatchEvent(new CustomEvent("click"))}render(){return it`
			...
			<svg width="148" height="22" viewBox="-4 -3 147 20" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				${this.annotationsToggled?at`<g class="icon icon__annotations">
						...
						/>
				  </g>`:at`<text y="16" class="icon ${this.annotations?"icon__annotations":"inactive"}"><tspan dx="75" class="glicon">&#xf113;</tspan></text>`}

				${this.revision?at`<rect
						class="interactive"
	...
	`,Kt([vt({type:Boolean,reflect:!0})],Qt.prototype,"annotations",2),Kt([vt({type:Boolean,reflect:!0})],Qt.prototype,"revision",2),Kt([vt({type:Boolean,reflect:!0,attribute:"annotations-toggled"})],Qt.prototype,"annotationsToggled",2),Kt([vt({type:Boolean,reflect:!0,attribute:"revision-toggled"})],Qt.prototype,"revisionToggled",2),Qt=Kt([yt("gk-editor-toolbar-svg")],Qt);const Jt=_e`
	:host {
		display: block;
		max-width: 69.2rem;
		width: calc(100% - 2rem);
...
`;var Yt=Object.defineProperty,eo=Object.getOwnPropertyDescriptor;let to=class extends lit_element_s{render(){return it`
			<!-- Don't reformat or let prettier reformat the SVG otherwise whitespace will get added incorrect and screw up the positioning -->
			<!-- a-prettier-ignore -->
		...
		`],to=((e,t,o,s)=>{for(var r,i=s>1?void 0:s?eo(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(i=(s?r(t,o,i):r(i))||i);return s&&i&&Yt(t,o,i),i})([yt("gk-focus-svg")],to);var oo=Object.defineProperty,no=Object.getOwnPropertyDescriptor;let so=class extends lit_element_s{render(){return it`
			<!-- Don't reformat or let prettier reformat the SVG otherwise whitespace will get added incorrect and screw up the positioning -->
			<!-- prettier-ignore -->
			<svg width="850" height="290" viewBox="0 0 850 290" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	`,so=((e,t,o,s)=>{for(var r,i=s>1?void 0:s?no(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(i=(s?r(t,o,i):r(i))||i);return s&&i&&oo(t,o,i),i})([yt("gk-graph-svg")],so);var ro=Object.defineProperty,io=Object.getOwnPropertyDescriptor,ao=(e,t,o,s)=>{for(var r,i=s>1?void 0:s?io(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(i=(s?r(t,o,i):r(i))||i);return s&&i&&ro(t,o,i),i};let co=class extends lit_element_s{render(){return it`
			<!-- Don't reformat or let prettier reformat the SVG otherwise whitespace will get added incorrect and screw up the positioning -->
			<!-- prettier-ignore -->
			<svg width="600" height="44" viewBox="0 0 600 42" fill="none" xmlns="http://www.w3.org/2000/svg">
				<defs>
	...
	`,ao([vt({type:Boolean,reflect:!0})],co.prototype,"toggled",2),co=ao([yt("gk-revision-navigation-svg")],co);var lo=Object.defineProperty,ho=Object.getOwnPropertyDescriptor;let po=class extends lit_element_s{render(){return it`
	...
	`,po=((e,t,o,s)=>{for(var r,i=s>1?void 0:s?ho(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(i=(s?r(t,o,i):r(i))||i);return s&&i&&lo(t,o,i),i})([yt("gk-timeline-svg")],po);var fo=Object.defineProperty,bo=Object.getOwnPropertyDescriptor;let uo=class extends lit_element_s{render(){return it`
			<!-- Don't reformat or let prettier reformat the SVG otherwise whitespace will get added incorrect and screw up the positioning -->
			<!-- a-prettier-ignore -->
			<svg width="850" height="290" viewBox="0 0 850 290" fill="none" xmlns="http://www.w3.org/2000/svg">
				<g>
		...
		`],uo=((e,t,o,s)=>{for(var r,i=s>1?void 0:s?bo(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(i=(s?r(t,o,i):r(i))||i);return s&&i&&fo(t,o,i),i})([yt("gk-workspaces-svg")],uo);var go=Object.defineProperty,yo=Object.getOwnPropertyDescriptor;let xo=class extends lit_element_s{render(){return it`
			<a
				class="video-button"
