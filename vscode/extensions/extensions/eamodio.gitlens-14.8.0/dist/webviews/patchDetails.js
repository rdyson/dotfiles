...
`),ln=[an,mt``],hn=[an,mt`
	...
	`,Tn([mo({type:Number})],Mn.prototype,"lines",2),Mn=Tn([uo("skeleton-loader")],Mn);class GlTreeBase extends GlElement{renderLoading(){return eo`
		...
		`],Dn([mo({type:Boolean})],Ln.prototype,"editor",2),Ln=Dn([uo("button-container")],Ln);var In=Object.defineProperty,Un=Object.getOwnPropertyDescriptor,Nn=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?Un(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&In(t,o,r),r};let Bn=class extends lit_element_s{constructor(){super(...arguments),this.full=!1,this.disabled=!1}get role(){return this.href?"link":"button"}updated(e){super.updated(e),e.has("disabled")&&this.setAttribute("aria-disabled",this.disabled.toString())}render(){return null!=this.href?eo`<a class="control" part="base" tabindex="${!1===this.disabled?-1:0}" href=${this.href}
				><slot></slot
			></a>`:eo`<button class="control" part="base" ?disabled=${this.disabled}><slot></slot></button>`}focus(e){this.control.focus(e)}blur(){this.control.blur()}click(){this.control.click()}};Bn.shadowRootOptions={...lit_element_s.shadowRootOptions,delegatesFocus:!0},Bn.styles=[an,mt`
			:host {
	...
	`,ii([mo()],ri.prototype,"name",2),ii([mo()],ri.prototype,"email",2),ii([mo({converter:jn(),reflect:!0})],ri.prototype,"date",2),ii([mo()],ri.prototype,"avatarUrl",2),ii([mo({type:Boolean})],ri.prototype,"showAvatar",2),ii([mo()],ri.prototype,"dateFormat",2),ii([mo({type:Boolean})],ri.prototype,"committer",2),ii([mo()],ri.prototype,"actionLabel",2),ri=ii([uo("commit-identity")],ri);var si=Object.defineProperty,ai=Object.getOwnPropertyDescriptor,ci=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?ai(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&si(t,o,r),r};let li=class extends lit_element_s{constructor(){super(...arguments),this.mode="infinite",this.active=!1,this.position="bottom"}firstUpdated(){this.setAttribute("role","progressbar")}render(){return eo`<div class="progress-bar"></div>`}};li.styles=mt`
		* {
			box-sizing: border-box;
		}
	...
	`,ci([mo({reflect:!0})],li.prototype,"mode",2),ci([mo({type:Boolean})],li.prototype,"active",2),ci([mo()],li.prototype,"position",2),li=ci([uo("progress-indicator")],li);var hi=Object.defineProperty,di=Object.getOwnPropertyDescriptor,pi=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?di(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&hi(t,o,r),r};let ui=class extends lit_element_s{constructor(){super(...arguments),this.collapsable=!1,this.expanded=!1,this.loading=!1}renderTitle(){return this.collapsable?eo`<button
		...
		`):void 0}renderExplainAi(){if(!1!==this.state?.orgSettings.ai)return eo`
	...
	`,wi([mo({type:Number})],_i.prototype,"added",2),wi([mo({type:Number})],_i.prototype,"modified",2),wi([mo({type:Number})],_i.prototype,"removed",2),_i=wi([uo("commit-stats")],_i);var ki=Object.defineProperty,$i=Object.getOwnPropertyDescriptor,xi=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?$i(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&ki(t,o,r),r};let Ai=class extends GlTreeBase{get create(){return this.state.create}get createChanges(){return Object.values(this.create.changes)}get createEntries(){return Object.entries(this.create.changes)}get hasWipChanges(){return this.createChanges.some((e=>"wip"===e?.type))}get selectedChanges(){return 1===this.createChanges.length?this.createEntries:this.createEntries.filter((([,e])=>!1!==e.checked))}get canSubmit(){return null!=this.create.title&&this.create.title.length>0&&this.selectedChanges.length>0}get fileLayout(){return this.state?.preferences?.files?.layout??"auto"}get isCompact(){return this.state?.preferences?.files?.compact??!0}get filesModified(){return Go(this.createChanges,(e=>e.files?.length??0))}get draftVisibility(){return this.state?.create?.visibility??"public"}constructor(){super(),dt(Ze,Qe,tt,lt,ht)}renderUserSelection(e){const t=e.pendingRole,o=new Map([["admin","admin"],["editor","can edit"],["viewer","can view"],["remove","un-invite"]]),n=o.get(t);return eo`
		...
		`}renderForm(){let e;switch(this.draftVisibility){case"private":e="organization";break;case"invite_only":e="lock";break;default:e="globe"}return eo`
			<div class="section section--action">
				...
				${Ao(!0===this.state?.orgSettings.byob,(()=>eo`<p class="h-deemphasize">
