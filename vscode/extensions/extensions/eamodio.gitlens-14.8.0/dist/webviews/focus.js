...
`;var Co=Object.defineProperty,Eo=Object.getOwnPropertyDescriptor,To=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?Eo(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&Co(t,o,r),r};let Po=class extends lit_element_s{constructor(){super(...arguments),this.full=!1,this.disabled=!1}get role(){return this.href?"link":"button"}updated(e){super.updated(e),e.has("disabled")&&this.setAttribute("aria-disabled",this.disabled.toString())}render(){return null!=this.href?jt`<a class="control" part="base" tabindex="${!1===this.disabled?-1:0}" href=${this.href}
				><slot></slot
			></a>`:jt`<button class="control" part="base" ?disabled=${this.disabled}><slot></slot></button>`}focus(e){this.control.focus(e)}blur(){this.control.blur()}click(){this.control.click()}};Po.shadowRootOptions={...lit_element_s.shadowRootOptions,delegatesFocus:!0},Po.styles=[So,Qe`
			:host {
		...
		`],To([ro(".control")],Po.prototype,"control",2),To([no({type:Boolean,reflect:!0})],Po.prototype,"full",2),To([no({type:Boolean,reflect:!0})],Po.prototype,"disabled",2),To([no({reflect:!0})],Po.prototype,"density",2),To([no()],Po.prototype,"href",2),To([no({reflect:!0})],Po.prototype,"role",1),To([no()],Po.prototype,"appearance",2),Po=To([eo("gl-button")],Po);var Oo=Object.defineProperty,No=Object.getOwnPropertyDescriptor,Lo=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?No(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&Oo(t,o,r),r};let zo=class extends lit_element_s{constructor(){super(...arguments),this.icon="",this.modifier="",this.size=16}updated(e){e.has("size")&&this.style.setProperty("--code-icon-size",`${this.size}px`),super.update(e)}};zo.styles=Qe`
		:host {
