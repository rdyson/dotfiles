...
- Click on empty Kafka explorer to add a new cluster. See [#87](https://github.com/jlandersen/vscode-kafka/blob/HEAD/https/github.com/jlandersen/vscode-kafka/pull/87).
