(function(){try{var n=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},e=new Error().stack;e&&(n._sentryDebugIds=n._sentryDebugIds||{},n._sentryDebugIds[e]="014dea83-b9ba-4dbf-a005-8f8eeeb2cb2c",n._sentryDebugIdIdentifier="sentry-dbid-014dea83-b9ba-4dbf-a005-8f8eeeb2cb2c")}catch{}})();const t=Object.freeze({displayName:"VHDL",fileTypes:["vhd","vhdl","vho","vht"],name:"vhdl",patterns:[{include:"#block_processing"},{include:"#cleanup"}],repository:{architecture_pattern:{patterns:[{begin:`(?x)
