(function(){try{var E=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},T=new Error().stack;T&&(E._sentryDebugIds=E._sentryDebugIds||{},E._sentryDebugIds[T]="89f95c7f-8937-4ad9-9356-07a2c2c60065",E._sentryDebugIdIdentifier="sentry-dbid-89f95c7f-8937-4ad9-9356-07a2c2c60065")}catch{}})();const A=Object.freeze({displayName:"DAX",name:"dax",patterns:[{include:"#comments"},{include:"#keywords"},{include:"#labels"},{include:"#parameters"},{include:"#strings"},{include:"#numbers"}],repository:{comments:{patterns:[{begin:"//",captures:{0:{name:"punctuation.definition.comment.dax"}},end:`
...
=
`,name:"keyword.control.dax"}]},{match:"[_$[:alpha:]][_$[:alnum:]]*",name:"variable.other.constant.dax"}]},strings:{begin:'"',end:'"',name:"string.quoted.double.dax",patterns:[{match:"\\\\.",name:"constant.character.escape.dax"}]}},scopeName:"source.dax"});var I=[A];export{I as default};
