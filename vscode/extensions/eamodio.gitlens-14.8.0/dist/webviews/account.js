...
`;var Pt=Object.defineProperty,Et=Object.getOwnPropertyDescriptor,Rt=(e,t,o,r)=>{for(var i,s=r>1?void 0:r?Et(t,o):t,c=e.length-1;c>=0;c--)(i=e[c])&&(s=(r?i(t,o,s):i(s))||s);return r&&s&&Pt(t,o,s),s};let Mt=class extends lit_element_s{constructor(){super(...arguments),this.full=!1,this.disabled=!1}get role(){return this.href?"link":"button"}updated(e){super.updated(e),e.has("disabled")&&this.setAttribute("aria-disabled",this.disabled.toString())}render(){return null!=this.href?lt`<a class="control" part="base" tabindex="${!1===this.disabled?-1:0}" href=${this.href}
				><slot></slot
			></a>`:lt`<button class="control" part="base" ?disabled=${this.disabled}><slot></slot></button>`}focus(e){this.control.focus(e)}blur(){this.control.blur()}click(){this.control.click()}};Mt.shadowRootOptions={...lit_element_s.shadowRootOptions,delegatesFocus:!0},Mt.styles=[St,Se`
			:host {
		...
		`],Rt([function(e,t){return(o,r,i)=>{const s=t=>t.renderRoot?.querySelector(e)??null;if(t){const{get:e,set:t}="object"==typeof r?o:i??(()=>{const e=Symbol();return{get(){return this[e]},set(t){this[e]=t}}})();return At(o,r,{get(){let o=e.call(this);return void 0===o&&(o=s(this),(null!==o||this.hasUpdated)&&t.call(this,o)),o}})}return At(o,r,{get(){return s(this)}})}}(".control")],Mt.prototype,"control",2),Rt([$t({type:Boolean,reflect:!0})],Mt.prototype,"full",2),Rt([$t({type:Boolean,reflect:!0})],Mt.prototype,"disabled",2),Rt([$t({reflect:!0})],Mt.prototype,"density",2),Rt([$t()],Mt.prototype,"href",2),Rt([$t({reflect:!0})],Mt.prototype,"role",1),Rt([$t()],Mt.prototype,"appearance",2),Mt=Rt([yt("gl-button")],Mt);var Tt=Object.defineProperty,Lt=Object.getOwnPropertyDescriptor,Dt=(e,t,o,r)=>{for(var i,s=r>1?void 0:r?Lt(t,o):t,c=e.length-1;c>=0;c--)(i=e[c])&&(s=(r?i(t,o,s):i(s))||s);return r&&s&&Tt(t,o,s),s};let zt=class extends lit_element_s{constructor(){super(...arguments),this.editor=!1}render(){return lt`<div class="group"><slot></slot></div>`}};zt.styles=[St,Se`
			:host {
				display: block;
				max-width: 30rem;
				margin-right: auto;
	...
	`,Ot([$t()],It.prototype,"icon",2),Ot([$t()],It.prototype,"modifier",2),Ot([$t({type:Number})],It.prototype,"size",2),It=Ot([yt("code-icon")],It);var Ht=Object.defineProperty,Nt=Object.getOwnPropertyDescriptor,Ft=(e,t,o,r)=>{for(var i,s=r>1?void 0:r?Nt(t,o):t,c=e.length-1;c>=0;c--)(i=e[c])&&(s=(r?i(t,o,s):i(s))||s);return r&&s&&Ht(t,o,s),s};let Gt=class extends lit_element_s{constructor(){super(...arguments),this.image="",this.name="",this.organizationsCount=0,this.days=0,this.state=o.Free,this.plan="",this.trialReactivationCount=0}get daysRemaining(){return this.days<1?"<1 day":F("day",this.days)}get planName(){switch(this.state){case o.Free:case o.FreePreviewTrialExpired:case o.FreePlusTrialExpired:return"GitKraken Free";case o.FreeInPreviewTrial:case o.FreePlusInTrial:return"GitKraken Pro (Trial)";case o.VerificationRequired:return`${this.plan} (Unverified)`;default:return this.plan}}get daysLeft(){switch(this.state){case o.FreeInPreviewTrial:case o.FreePlusInTrial:return`, ${this.daysRemaining} left`;default:return""}}get hasAccount(){return null!=(e=this.state)&&0!==e&&2!==e&&1!==e;var e}get isReactivatedTrial(){return this.state===o.FreePlusInTrial&&this.trialReactivationCount>0}renderAccountInfo(){return this.hasAccount?lt`
			<div class="account">
				...
				<div class="account__details">
					...
					${kt(0===this.organizationsCount,(()=>lt`<p class="account__access">${this.planName}${this.daysLeft}</p>`))}
				</div>
		...
		`:bt}renderOrganization(){return this.hasAccount&&this.organization?lt`
			<div class="account account--org">
				...
				${kt(this.organizationsCount>1,(()=>lt`<div class="account__signout">
		...
		`:bt}renderAccountState(){const e=new Date("2023-12-31T07:59:00.000Z").getTime(),t=Date.now()<e;switch(this.state){case o.VerificationRequired:return lt`
				...
				`;case o.FreePlusTrialExpired:return lt`
					...
					${kt(t,(()=>lt`<p style="text-align: center;">
								<a
				...
				`}return bt}render(){return lt`${this.renderAccountInfo()}${this.renderOrganization()}${this.renderAccountState()}`}};Gt.styles=[St,Ct,Se`
			:host {
				display: block;
