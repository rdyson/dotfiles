...
windowLayoutMode.statusMessage = message.new('Window Layout Mode (hyper-s)')
...
windowLayoutMode:bindWithAutomaticExit({'shift'}, 'h', function()
  hs.window.focusedWindow():left60()
end)

windowLayoutMode:bindWithAutomaticExit({'shift'}, 'l', function()
  hs.window.focusedWindow():right40()
end)
...
windowLayoutMode:bind({'shift', 'ctrl', 'alt', 'cmd'}, 's', function()
